...
// ✅ Componente reutilizável para os botões de navegação
function NavigationButton({ icon, label, isActive = false, onClick = () => {}, darkMode }) {
    return (
        <button
            onClick={onClick}
            className={`px-4 py-2 rounded-md text-sm font-medium transition-all flex items-center gap-2 cursor-pointer whitespace-nowrap ${
                isActive
                    ? darkMode
    ...
    return (
        <div className="flex min-h-screen">
            ...
            >
                ...
                >
                    <div className="mx-auto px-6 py-3 flex items-center gap-3 overflow-x-auto scrollbar-none">
                        <NavigationButton
                                        ...
                                        {laidOut.map((ev) => {
                                            ...
                                            return (
                                                <button
                                                    ...
                                                    className={`absolute rounded ${s.bg} ${s.text} shadow-sm cursor-pointer hover:shadow-lg hover:z-10 transition-all pulse-card backdrop-blur-md ring-1 ring-white/10 ${darkMode ? "border-2 border-gray-700" : "border-2 border-blue-200"
                                                        }`}
